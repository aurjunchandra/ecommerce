          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> 
                    <a class="nav-link" href="{{url('/category/add')}}">Add</a>
                  </li>

                  <li class="nav-item"> 
                    <a class="nav-link" href="{{url('/category/manage')}}">Manage</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="brand">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> 
                    <a class="nav-link" href="{{url('/brand/add')}}">Add</a>
                  </li>

                  <li class="nav-item"> 
                    <a class="nav-link" href="{{url('/brand/manage')}}">Manage</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="product">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> 
                    <a class="nav-link" href="{{url('/product/manage')}}">Manage</a>
                  </li>
                </ul>
              </div>
            </li>
